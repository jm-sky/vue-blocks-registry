...
import { Edit, Key, Mail, User as UserIcon } from 'lucide-vue-next'
  ...
  <div class="space-y-6">
    ...
    <div v-if="isLoading" class="bg-card border rounded-lg p-6">
      <div class="flex items-center space-x-6">
        <div class="size-24 rounded-full bg-muted animate-pulse" />
    ...
    <div v-else-if="profile" class="bg-card border rounded-lg p-6 space-y-6">
      ...
      <div class="border-t pt-4 space-y-4">
        <div class="grid gap-4 md:grid-cols-2">
          <div class="space-y-1">
            <label class="text-xs uppercase tracking-wide text-muted-foreground">{{ t('user.profile.user_id_label') }}</label>
        ...
        <div class="pt-4 border-t">
          <ButtonLink variant="outline" :to="{ name: 'ChangePassword' }">

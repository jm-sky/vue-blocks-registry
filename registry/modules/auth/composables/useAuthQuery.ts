// modules/auth/composables/useAuthQuery.ts
...
/**
 * Main auth hook that combines all auth operations with TanStack Query
 * This replaces the original useAuth composable
 */

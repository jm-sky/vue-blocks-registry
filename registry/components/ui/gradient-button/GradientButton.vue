...
/*
  https://github.com/unovue/inspira-ui/blob/main/components/content/inspira/ui/gradient-button/GradientButton.vue
  MIT License
*/
...
<template>
  <button
    :class="cn('relative flex items-center justify-center min-w-28 min-h-10 overflow-hidden before:absolute before:-inset-[200%] animate-rainbow rainbow-btn', props.class)"
  >

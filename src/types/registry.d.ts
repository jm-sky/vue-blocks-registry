 ...
 */
export type RegistryType = 'registry:ui' | 'registry:component' | 'registry:block' | 'registry:lib' | 'registry:hook' | 'registry:page' | 'registry:file' | 'registry:feature';
export type FileType = 'registry:ui' | 'registry:component' | 'registry:block' | 'registry:lib' | 'registry:hook' | 'registry:page' | 'registry:file';

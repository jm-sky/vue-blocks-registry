...
const categories = computed(() => [
  {
    title: t('demo.overview.buttons.title'),
  ...
  {
    title: t('demo.overview.links.title'),
    description: t('demo.overview.links.description'),
  ...
  {
    title: t('demo.overview.layout.title'),
    description: t('demo.overview.layout.description'),
  ...
  {
    title: t('demo.overview.dataTable.title'),
  ...
  <div class="space-y-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-slide-up">
      <CategoryCard
        ...
        :icon-component="category.iconComponent"

...
✅ **Rozwiązane** - moduł został przemianowany z `logs` na `logs-management` w dniu 2025-11-06

## Powiązane pliki

- `registry/modules/logs-management/` - moduł logs-management (wcześniej `logs`)
- `.gitignore` - nie wymaga już wyjątków, moduł nie koliduje z wzorcami gitignore

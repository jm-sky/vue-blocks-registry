...
❌ **Usuwanie konta** - nie jest zaimplementowane ani w backendzie, ani w frontendzie
...
✅ **Rozwiązane (Faza 1)** - Podstawowa funkcjonalność usuwania konta została zaimplementowana w dniu 2025-11-06
- Backend endpoint DELETE /api/auth/account
- Soft delete z anonimizacją danych
- Usunięcie powiązanych danych (2FA, passkeys)
- Frontend modal potwierdzenia
- Integracja z API

Faza 2 i 3 pozostają do przyszłej implementacji.
